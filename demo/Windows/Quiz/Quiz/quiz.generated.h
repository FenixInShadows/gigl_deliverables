...
double MathQuiz__ConfigLambda__48__29(const GiglConfig  & config, signed int  depth);
double MathQuiz__ConfigLambda__49__29(const GiglConfig  & config, signed int  depth);
signed int MathQuiz__ConfigLambda__50__26(const GiglConfig  & config, signed int  depth);
signed int MathQuiz__ConfigLambda__50__38(const GiglConfig  & config, signed int  depth);
double MathQuiz__ConfigLambda__50__59(const GiglConfig  & config, signed int  depth);
double MathQuiz__ConfigLambda__48__29(const GiglConfig  & config, signed int  depth)
{
...
void GenerateQuizListIncDiffic(MathQuiz  * * list)
{
  ...
  {
    signed int diffic = 0;
    GiglConfig quiz_config = (GiglConfig(5, 5, ((sizeof(signed int *)) + ((sizeof(signed int *)) + ((sizeof(signed int *)) + ((sizeof(signed int *)) + (sizeof(signed int *)))))), (SizeVec{(sizeof(signed int *)), (sizeof(signed int *)), (sizeof(signed int *)), (sizeof(signed int *)), (sizeof(signed int *))}), (VarPtrVec{((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(diffic))))), ((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(diffic))))), ((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(diffic))))), ((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(diffic))))), ((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(diffic)))))}), (IndexVec{0, 1, 3, 4, 2}), (FuncPtrVec{((FuncPtr)(&(MathQuiz__ConfigLambda__48__29))), ((FuncPtr)(&(MathQuiz__ConfigLambda__49__29))), ((FuncPtr)(&(MathQuiz__ConfigLambda__50__26))), ((FuncPtr)(&(MathQuiz__ConfigLambda__50__38))), ((FuncPtr)(&(MathQuiz__ConfigLambda__50__59)))})));
    for(; ((diffic) < 5); ((diffic)++))
    {
