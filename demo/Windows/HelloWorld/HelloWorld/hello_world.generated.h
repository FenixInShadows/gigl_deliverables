...
double Greeting__ConfigLambda__27__37(const GiglConfig  & config);
double Greeting__ConfigLambda__27__48(const GiglConfig  & config);
double Greeting__ConfigLambda__27__37(const GiglConfig  & config)
{
...
Greeting  *GenerateGreeting()
{
  ...
  {
    return (new Greeting((GiglConfig(0, 2, 0, (SizeVec{}), (VarPtrVec{}), (IndexVec{0, 1}), (FuncPtrVec{((FuncPtr)(&(Greeting__ConfigLambda__27__37))), ((FuncPtr)(&(Greeting__ConfigLambda__27__48)))})))));
  }
}
