...
signed int LTree__ConfigLambda__62__37(const GiglConfig  & config);
double LTree__ConfigLambda__62__40(const GiglConfig  & config);
double LTree__ConfigLambda__62__50(const GiglConfig  & config);
double LTree__ConfigLambda__63__21(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__63__26(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__63__35(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__63__56(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
signed int LTree__ConfigLambda__62__37(const GiglConfig  & config)
{
...
LTree  *GenerateDetermLTree(signed int  n, double  unit_len)
{

  {
    ...
    return (new LTree((GiglConfig(4, 7, ((sizeof(signed int *)) + ((sizeof(double *)) + ((sizeof(double *)) + (sizeof(signed int *))))), (SizeVec{(sizeof(signed int *)), (sizeof(double *)), (sizeof(double *)), (sizeof(signed int *))}), (VarPtrVec{((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(n))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_len))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(max_wid))))), ((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(n)))))}), (IndexVec{0, 1, 2, 5, 6, 3, 4}), (FuncPtrVec{((FuncPtr)(&(LTree__ConfigLambda__62__37))), ((FuncPtr)(&(LTree__ConfigLambda__62__40))), ((FuncPtr)(&(LTree__ConfigLambda__62__50))), ((FuncPtr)(&(LTree__ConfigLambda__63__21))), ((FuncPtr)(&(LTree__ConfigLambda__63__26))), ((FuncPtr)(&(LTree__ConfigLambda__63__35))), ((FuncPtr)(&(LTree__ConfigLambda__63__56)))})))));
  }
}
signed int LTree__ConfigLambda__69__37(const GiglConfig  & config);
double LTree__ConfigLambda__69__40(const GiglConfig  & config);
double LTree__ConfigLambda__69__50(const GiglConfig  & config);
double LTree__ConfigLambda__70__21(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__70__26(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__70__55(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__70__88(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
signed int LTree__ConfigLambda__69__37(const GiglConfig  & config)
{
...
LTree  *GenerateNDLTree(signed int  n, double  unit_len)
{
  ...
  {
    double max_wid = ((double)((1 << (n))));
    return (new LTree((GiglConfig(4, 7, ((sizeof(signed int *)) + ((sizeof(double *)) + ((sizeof(double *)) + (sizeof(signed int *))))), (SizeVec{(sizeof(signed int *)), (sizeof(double *)), (sizeof(double *)), (sizeof(signed int *))}), (VarPtrVec{((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(n))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_len))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(max_wid))))), ((VarPtr)(&((*((signed int * *)((malloc)((sizeof(signed int *)))))) = (&(n)))))}), (IndexVec{0, 1, 2, 5, 6, 3, 4}), (FuncPtrVec{((FuncPtr)(&(LTree__ConfigLambda__69__37))), ((FuncPtr)(&(LTree__ConfigLambda__69__40))), ((FuncPtr)(&(LTree__ConfigLambda__69__50))), ((FuncPtr)(&(LTree__ConfigLambda__70__21))), ((FuncPtr)(&(LTree__ConfigLambda__70__26))), ((FuncPtr)(&(LTree__ConfigLambda__70__55))), ((FuncPtr)(&(LTree__ConfigLambda__70__88)))})))));
  }
}
...
signed int LTree__ConfigLambda__86__37(const GiglConfig  & config);
double LTree__ConfigLambda__86__40(const GiglConfig  & config);
double LTree__ConfigLambda__86__50(const GiglConfig  & config);
double LTree__ConfigLambda__87__21(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__87__46(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__87__75(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
double LTree__ConfigLambda__87__121(const GiglConfig  & config, signed int  depth, const Vector2D  & start, const Vector2D  & dir, double  bottom_w, double  top_w);
signed int LTree__ConfigLambda__86__37(const GiglConfig  & config)
{
